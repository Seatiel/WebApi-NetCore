...
namespace EjemploApi.Controllers
{
    ...
    public class CobrosController : Controller
    {
        ...
        public async Task<IActionResult> GetCobros([FromRoute] int id)
        {
            ...
            var cobros = await _context.Cobros.SingleOrDefaultAsync(m => m.IdCobros == id);
        ...
        public async Task<IActionResult> PostCobros([FromBody] Cobros cobros)
        {
            ...
            return CreatedAtAction("GetCobros", new { id = cobros.IdCobros }, cobros);
        }
        ...
        {
            return _context.Cobros.Any(e => e.IdCobros == id);
        }
    }
}